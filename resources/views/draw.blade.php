    ...
    <div class="container py-12 max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 lg:grid-cols-12 gap-5">
            <div class="col-span-12">
                ...
                <div x-data="{ isVisible: true }" x-init="setTimeout(() => { isVisible = !isVisible }, 3000)">
                    <div x-show="isVisible" role="status" class="text-center">
                ...
                <div x-data="{ isVisible: false }" x-init="setTimeout(() => { isVisible = !isVisible }, 3000)">
                <table x-show="isVisible">
                    <colgroup>
                        <col>
