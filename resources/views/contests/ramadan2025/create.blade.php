...
<head>
    ...
    <title>مسابقة رمضان 2025 - شركة المغامرة للترفيه</title>
...
<div class="container mx-auto mt-10">
    <div class="grid grid-cols-12 text-center">
        <div class="col-start-2 col-span-10">
            ...
            <h1 class="text-center my-5 text-2xl">✨🌙 مسابقة رمضان✨🌙</h1>
            ...
            {{-- Form --}}
            <form action="{{ route('contests.ramadan2025.enter') }}" method="post">
                {{ csrf_field() }}
                <div class="bg-white mt-5 rounded-xl p-10">
                    ...
                    <p>ما هو العام الذي فرض به الله الصّيام على أمّة الإسلام للمرّة الأولى؟</p>
                    ...
                    <div class="w-full max-w-sm min-w-[200px] mt-2 mx-auto">
                        <select name="answer" class="text-center bg-transparent border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            ...
                            <option value="1">العام الفيل</option>
                            <option value="2">العام الثاني للهجرة</option>
                            <option value="3">العام الصقر</option>
                        </select>
                    ...
                    <h2 class="mt-5 font-thin"><b>يوزر الحساب (انستقرام او تويتر او ... الخ)</b></h2>
                    <div class="w-full max-w-sm min-w-[200px] mt-2 mx-auto">
                ...
                <ul class="mt-5">
                    <li>
                        ...
                        <ul class="list-disc mr-5">
                            <li>الإجابة على السؤال في رابط المسابقة داخل الباركود</li>
                            <li>متابعة لحساب عالم المغامرة في انستقرام</li>
                            <li>منشن في بوست المسابقة لخمسة أشخاص</li>
                            <li>شير للبوست في الستوري</li>
                        </ul>
                    </li>
                    <li class="mt-5">
                        <strong>طريقة الاشتراك:</strong>
                        <ul class="list-disc mr-5">
                            <li>يتم الاشتراك في السحب من خلال المشاركة الجواب على السؤال في الرابط.</li>
                    ...
                    <li class="mt-5">
                        ...
                        <ul class="list-disc mr-5">
                            <li>يبدأ السحب بتاريخ (-) وينتهي بتاريخ (-).</li>
            ...
            <div class="text-center justify-center rounded-xl my-5" style="background: url('/ramadan2025.png');background-position:center;background-size:cover;height:300px;">
            </div>
