                ...
                <ul class="mt-5">
                    <li>
                        ...
                        <ul class="list-disc mr-5">
                            <li>الإجابة في الرابط وتعبئة البيانات</li>
                            <li>شير لبوست المسابقة في الستوريز</li>
                            <li>فولو لحساب عالم المغامرة في انستقرام</li>
                            <li>منشن لخمسة من اصدقاءك في الكومنتات للمشاركة على البوست</li>
                        </ul>
                    </li>
                    <li class="mt-5">
                    ...
                    <li class="mt-5">
                        ...
                        <ul class="list-disc mr-5">
                            <li>يبدأ السحب بتاريخ (01-02-2025) وينتهي بتاريخ (24-02-2025).</li>
                    ...
                    <li class="mt-5">
                        ...
                        <ul class="list-disc mr-5">
                            ...
                            <li>سيتم الإعلان عن الفائزين بتاريخ (24) من خلال حساباتنا على المواقع الإجتماعية.</li>
                        </ul>
                    </li>
                    <li class="mt-5">
                        <strong>الجوائز:</strong>
                        <ul class="list-disc mr-5">
                            <li>الفائز الأول: قسيمة تأجير من متجر عالم المغامرة بمبلغ 1000 ريال</li>
                            <li>الفائز الثاني: قسيمة تأجير من متجر عالم المغامرة بمبلغ 800 ريال</li>
                            <li>لفائز الثالث: قسيمة تأجير من متجر عالم المغامرة بمبلغ 700 ريال</li>
                            <li>الفائز الرابع: قسيمة تأجير من متجر عالم المغامرة بمبلغ 600 ريال</li>
                            <li>الفائز الخامس: قسيمة تأجير من متجر عالم المغامرة بمبلغ 500 ريال</li>
                        </ul>
                    </li>
                    <li class="mt-5">
